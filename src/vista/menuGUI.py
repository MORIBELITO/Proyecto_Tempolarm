...
import Proyecto_Tempolarm.src.vista.recursos_rc
...
"background-color: rgb(111, 1, 1);")
        ...
        self.comboBox.setMaximumSize(QSize(90, 40))
        self.comboBox.setStyleSheet(u"text-align:center;\n"
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox.setItemText(0, QCoreApplication.translate("MainWindow", u"AM", None))
        self.comboBox.setItemText(1, QCoreApplication.translate("MainWindow", u"PM", None))
